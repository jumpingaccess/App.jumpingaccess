...
Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    get "monitoring/rabbitmq"
    get "monitoring/nodejs"
    get "monitoring/competitions"
    get "meetings/show"
    get "dashboard/index"
    ...
    resources :monitoring, only: [:index] do
      collection do
        ...
        get :nodejs
        get :competitions
        get :status # Pour les appels AJAX
        post :send_command  # ← Ajoutez cette ligne
      end
    end
  ...
  get '/admin/import/equipe', to: 'admin/imports#from_equipe', as: 'import_equipe'
  post '/admin/import/equipe', to: 'admin/imports#process_equipe_import'
  get '/admin/import/equipe/meetings', to: 'admin/imports#meetings' # Nouvelle route AJAX
